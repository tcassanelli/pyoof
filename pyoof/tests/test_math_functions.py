...
def test_co_matrices():
    ...
    res = np.load(
        os.path.join(relative_path, 'data_math_functions/res_co_matrices.npy')
        )
    jac = np.load(os.path.join(
        relative_path, 'data_math_functions/jac_co_matrices.npy')
        )
    cov_true = np.load(
        os.path.join(relative_path, 'data_math_functions/cov_co_matrices.npy')
        )
    corr_true = np.load(
        os.path.join(relative_path, 'data_math_functions/corr_co_matrices.npy')
        )
