...
> error: [Errno 2] Could not find C/C++ file pyoof/pathprof/cyprop.(c/cpp)
> for Cython file pyoof/pathprof/cyprop.pyx when building extension
> pyoof.pathprof.cyprop. Cython must be installed to build from a git
> checkout.: 'pyoof/pathprof/cyprop.c'

Delete the file "pyoof/cython_version.py"
